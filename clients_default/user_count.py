...
user_counts_file = os.path.join(a_path, get_current_project_number, "user_counts.json")
ranked_clients_file = os.path.join(a_path, get_current_project_number, "ranked_clients.json")
